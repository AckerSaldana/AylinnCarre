      ...
      <div className="container">
        ...
        <div className="contacto__info">
          ...
          <div className="contacto__row">
            ...
            <div className="contacto__item">
              <a href="https://instagram.com/xyrin.studio" target="_blank" rel="noopener noreferrer" className="contacto__social-link" aria-label="Instagram">
                <svg className="contacto__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="https://tiktok.com/@xyrin.studio" target="_blank" rel="noopener noreferrer" className="contacto__social-link" aria-label="TikTok">
                <svg className="contacto__icon" viewBox="0 0 24 24" fill="currentColor">
